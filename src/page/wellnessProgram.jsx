...
const WellnessProgram = () => {
  return (
    <Fragment>
      <Helmet>
        <title>Charusat University | Best University in Gujarat | Private University</title>
        <meta http-equiv="Content-Type" content=" text/html; charset=utf-8" />
        <meta http-equiv="x-ua-compatible" content="ie=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="description" content="Charusat University is one of the Best University in Gujarat located in Changa- Anand. Charusat University provides best education in various domains like Engineering, Pharmacy, Business management, Applied Science, Nursing, Physiotherapy, Computer application, Paramedical Courses and many more." />
        <meta name="keywords" content="Charusat, Best University in Gujarat, Top Private university in Gujarat, Changa university, University, Charusat university admission, Under graduate admission, Anand, Changa, Vallabh Vidyanagar, Gujarat, India, Education, Educational institute" />
        <meta name="robots" content="index" />
        <meta name="robots" content="follow" />
        <meta name="googlebot" content="index, follow" />
        <meta name="google" content="translate" />
        <meta name="google" content="nopagereadaloud" />
        <meta name="google-site-verification" content="iHUSfPMMFQRCIgicrAlVofHWVhWwQsDgTzGNUC7WzMk" />
        <meta property="og:type" content="homepage" />
        <meta property="og:title" content="CHARUSAT Homepage" />
        <meta property="og:description" content="CHARUSAT University - best university to study in Gujarat." />
                        ...
                        <div className="post-inner">
                          <div className="post-content">
                            ...
                            <div className="meta-post">
                              <h4>PREAMBLE</h4>
                              <hr />
                              <p style={{ "textAlign": "justify" }}>Students arriving at University for the first time or embarking on a programme may have to learn to adapt to significant changes, such as moving to a new area, separation from family and friends, establishing a new social network, managing a tight budget, combining academic study with family commitments and also adjusting to different cultures. These changes are exciting, challenging and an intrinsic part of the attraction of going to University. All these warrant facilitation of students towards a new turn in their journey of life.</p>
                              <p>CHARUSAT, through Student Counselling System, aims to foster academic excellence, positive mental attitude and general well-being of the students.</p>
                              <p style={{ "textAlign": "justify" }}>The Student Counselling System is a proactive and potential building activity that identifies the true potential of the students and brings it out, so as to facilitate students to achieve their academic and personal goals. The system shall be comprising of Counsellors, primarily the teachers, and the students themselves.</p>
                              {/* <br/>
                              ...
                              <p>
                                ...
                                <li>The Teacher Counsellor is expected to undertake and execute:
                                  <ol start={"a"}>
                                    ...
                                    <li>Analyzing Results and maintaining a growth chart of their counsellees and keeping parents updated about the same. These shall include results of all types of assessments like Internal Examination, External Examination, Practical, Assignments, Projects, Industrial Training, etc.</li>
                                    <li>Helping Counsellees to identify and address the academic challenges faced.</li>
                                    <li>Career Guidance to the Counsellees.</li>
                                    <li>Addressing Personal problems and social matters of the Counsellees.</li>
                                    <li>Facilitating Event participations and Professional Development of the Counsellees.</li>
                                    <li>Facilitating application for Convocation for Final Degree.</li>
                                    <li>Helping counsellees use the ERP system to the fullest.</li>
                                    <li>Helping maintenance of alumni data, etc.</li>
                                  </ol>
                                </li>
                                ...
                                <li>The Counselling should be undertaken in a planned manner to ensure continuity and consistency.</li>
                                <li>The counsellors shall keep the parents of their counsellees informed regularly at a maximum interval of one month.</li>
                            ...
                            <p>
                              ...
                              <ul>
                                <li>One Teacher Counsellor will be allocated to 15 to 25 students for counselling. (Please refer General Guidelines for details)</li>
                                <li>Teacher Counsellor will report to Department Counselling Coordinator twice in every semester through Mentor Report.</li>
                                <li>For students requiring immediate attention and remedial action, Teacher Counsellor shall immediately refer the said students directly to Institute Counsellor [Principal/HoD (Engg.)]</li>
                              </ul>
                              <b>Department Counselling Co-ordinator</b> – A Senior Faculty, having more than 05 years of teaching experience will be the Department Counselling Co-ordinator.
                              <ul>
                                <li>Department Counselling Co-ordinator will look after the counselling at departmental level and coordinate with the Teacher Counsellors for continuous feedback on the progress of the students twice in a semester.</li>
                                <li>Department Counselling Co-ordinator, having proven track record of effective teaching and counselling, shall also undertake the responsibility of meeting once in a month and guiding the “Potential Learners” and “Progressive Learners”, as referred by different Teacher Counsellors.</li>
                                <li>Considering the number of students referred by the Teacher Counsellors, additional Department Counselling Co-ordinators may be assigned by the Institute Counsellor.</li>
                                <li>The Department Counselling Coordinator shall report the progress made by the counselled students to Institute Counsellor [Principal/HoD (Engg.)] for necessary actions, wherever needed, once in every quarter.</li>
                              </ul>
                              <b>Institute Counsellor</b> - The Head of the Department will be the Institute Counsellor. For Institutes other than CSPIT, “Principal” shall be the “Institute Counsellor”.
                              <ul>
                                <li>
                            ...
                            <p>
                              <ol>
                                ...
                                <li>The Counsellor should ensure that all the Counsellees under him/her have filled in all their personal details on e-governance of the University within two weeks of beginning of the Term.</li>
                                <li>The counsellors shall have a continuous observation of the academic performance, relation with the peers, behavior patterns and psychological conditions of their counsellees, so as to be able to track any irregularity at an earlier stage and suggest corrective actions.</li>
                                <li>There upon, the counsellors shall conduct meeting, once in a fortnight, with their counselleess, so as to be able to keep a track of their progress in academic, social and personal fronts. These meets need to be recorded with signature of the Counsellor as well as the Counsellee.</li>
                                <li>SWP Counsellor conducts “Group Interaction Sessions” to assess the overall wellness level of the students. SWP Counsellor gets the “Student Wellness Questionnaire” filled up by the students to ascertain the patterns of further counselling support required.
                                  <br /><br />
                                  The Questionnaire is based on psychometric principles to measure key aspects of human personality namely:
                                  <div className="row">
                                    <div className="col-sm-4">
                                      <ul>
                                        <li>Positive Personal Traits</li>
                                        <li>Dark Personal Traits</li>
                                        <li>Motivation, Values, Preferences</li>
                                ...
                                <li>After completion of a Semester and announcement of results of the students, the Teacher Counsellor will segregate their respective counsellees on the basis of academic Performance as under:
                                  <ul>
                                    <li><b>Potential Learners:</b> CGPA &lt; 5</li>
                                    <li><b>Progressive Learners:</b> CGPA 5 to 7</li>
                                    <li><b>Proficient Learners:</b> CGPA above 7</li>
                                  </ul>
                                </li>
                                <li>Herein, the Teacher Counsellor should arrange for frequent sessions with the <b>‘Potential Learners’</b> and <b>‘Progressive Learners’</b> and guide them to focus on clearing the backlogs first, if any, and subsequently endeavour towards improving CGPA/SGPA.</li>
                                <li>Further, the Teacher Counsellor shall refer the <b>‘Potential Learners’</b> and <b>‘Progressive Learners’</b> to Department Counselling Co-ordinators, once in a month as outlined under Counselling Structure – Department Counselling Co-ordinator.</li>
                            ...
                            <p>
                              ...
                              <ul>
                                ...
                                <li>The objective of Reach Program is to reach out to maximum Students and their Mentors as well as to the Parents, wherever need be, through compassionate therapeutic interventions, so as to promote renewed hopes, personal fulfillment and academic enrichment.</li>
                              </ul>
                              <b>Student Happiness and Progression Survey:</b>
                              <ul>
                                <li>In line with SWP Group Sessions, HRDC proposes to initiate a Survey: Phase 2 under the caption ‘Student Happiness and Progression Survey’ in order to get a feel of the First Year Student’s Academic and Emotional bonding with University.</li>
                                <li>The objective is to be in constant touch with student’s need and the improvement required there upon. This will also serve as secondary data for NAAC criteria under Student Satisfaction Survey.</li>
                              </ul>
                              <b>SWP Research Approach towards Psycho-Social Elements:</b>
                              <ul>
