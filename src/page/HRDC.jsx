      ...
      <div className="blog-section padding-tb section-bg">
        <div className="container">
          <div className="row justify-content-center">
                      ...
                      <div className="post-item style-2">
                        <div className="post-inner">
                          <div className="post-content">
                            ...
                            <div className="meta-post" >
                              <h4>Competency Mapping Workshops</h4>
                            ...
                            <div className="meta-post" >
                              ...
                              In addition to the above, initially, HRDC organized a seminar by Dr. VG Patel on <strong> “How to Teach”,</strong> a talk on Education in US Universities by Prof. Rebecca Manring of Indiana University and an interactive Yoga Practice session-cum-lecture on “To Live is to Grow” by Yogacharya Shri Bhaandevji for the benefit of the faculty and non-teaching staff of CHARUSAT.
                            </div>
                            <div className="meta-post" >
                              <h4>Attitudinal Change Training Programme</h4>
                            ...
                            <div className="meta-post" >
                              <h4>Summer Training Programme</h4>
                            ...
                            <div className="meta-post" >
                              <h4>Training for Interactive Pad</h4>
                            ...
                            <div className="meta-post" >
                              <h4>Prof. S K Patel’s Interaction</h4>
                            ...
                            <div className="meta-post" >
                              <h4>Talk-A-Thon – A Discussion Forum</h4>
                            ...
                            <div className="meta-post" >
                              <h4>Swami Anubhavanandaji’s Motivational Discourse</h4>
                            ...
                            <div className="meta-post" >
                              <h4>Expert Talk by Dr V G Patel</h4>
            ...
            <Contact
      name="Contact Person: Dr. Ashwin Makwana"
      email="head.hrdc@charusat.ac.in"
      phone=" 5181"
      />
          </div>
        </div>
