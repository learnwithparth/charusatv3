                    ...
                    <div className="accordion" id="accordionExample">
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion01">
                          ...
                          >
                            <span>Standard Operating Procedures</span> <span><i className="icofont-square-down"></i></span>
                          </button>
                        </div>
                        <div
                          id="videolist1"
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                <a
                                  ...
                                  target="_blank"
                                >
                                  4. review_of_clinical_trial_protocol
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion02">
                          ...
                          >
                            <span>Annexures</span><span><i className="icofont-square-down"></i></span>
                          </button>
                        </div>
                        <div
                          id="videolist2"
                          ...
                          <ul className="lab-ul video-item-list">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  2.1
                                  format_for_declaration_of_conflict_of_interest_for_iec_members_or_investigators
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  3.
                                  rights_responsibilities_of_research_participants
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  4.
                                  application_format_for_investigator_initiated_full_committee_or_exempt_review_project
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  4.1
                                  protocol_format_for_investigator_initiated_full_committee_or_exempt_review_project
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                <a
                                  ...
                                  target="_blank"
                                >
                                  4.2 participant_information_sheet
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  5.
                                  application_format_for_industry_or_government_initiated_full_committee_review_project
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                <a
                                  ...
                                  target="_blank"
                                >
                                  5.1 participant_information_sheet
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  6.
                                  application_format_for_investigator_initiated_case_reports_reveiw
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  6.1
                                  protocol_format_for_investigator_initiated_case_reports_reveiw
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                <a
                                  ...
                                  target="_blank"
                                >
                                  6.2 case_report_consent_or_assent_form
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  7.
                                  project_submission_check_lists_for_investigators
                                  BMR
                                </a>
                              </div>
                            </li>
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  8.
                                  format_of_response_to_query_letter_by_investigator
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  9.
                                  format_of_approval_letter_by_institutional_ethics_committee
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  10.1
                                  av_consenting_monitoring_report_-_regulated_trial
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  11.
                                  who_tool_for_causality_assessment-converted
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  13.
                                  format_of_iec_report_to_cdsco_in_case_of_sae
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  16.
                                  checklist_informed_consent_document-converted
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                <a
                                  ...
                                  target="_blank"
                                >
                                  18. checklist_For_Clinical_Trial
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                            ...
                            <li className=" d-flex flex-wrap justify-content-between">
                              <div className="video-item-title">
                                ...
                                >
                                  22.
                                  research_participant_interview_guide_english
                                </a>
                              </div>
                            </li>
                            <li className=" d-flex flex-wrap justify-content-between">
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion03">
                          ...
                          >
                            <span>Registration</span><span><i className="icofont-square-down"></i></span>
                          </button>
                        </div>
                        <div
                          id="videolist3"
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion04">
                          ...
                          >
                            <span>Approved Projects</span><span><i className="icofont-square-down"></i></span>
                          </button>
                        </div>
                        <div
                          id="videolist4"
                      ...
                      <div className="accordion-item">
                        <div className="accordion-header" id="accordion05">
                          ...
                          >
                            <span>Proposal Submission</span><span><i className="icofont-square-down"></i></span>
                          </button>
                        </div>
                        <div
                          id="videolist5"
