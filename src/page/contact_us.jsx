                                        ...
                                        <div className="accordion" id="accordionExample">
                                            <div className="accordion-item">
                                                <div className="accordion-header" id="accordion01">
                                                    <button className="d-flex flex-wrap justify-content-between" data-bs-toggle="collapse" data-bs-target="#videolist1" aria-expanded="true" aria-controls="videolist1" onClick={() => setIsActive(!isActive)}><span>Lodge Complaint</span> <span>{isActive ? '-' : '+'}</span> </button>
                                                </div>
                                                <div id="videolist1" className="accordion-collapse collapse" aria-labelledby="accordion01" data-bs-parent="#accordionExample">
                                                <div className="row">
                                                    <div className="col-lg-8">
                                                        <br/>
                                                    <p>CHARUSAT believes in the principles of Honesty, Integrity and Transparency. The University aims to provide a harmonic environment to all the students, employees, associates and stakeholders. To facilitate these, various cells at University are established like Grievance Redressal Cell, Equal Opportunity Cell, Women Development Cell, Cell for Prevention of Sexual Harassment and Anti-Ragging Cell. Any stakeholder who finds any discrepancy under the aegis of different cells can use this E-box to register a complaint and University will take further actions to resolve the problem.</p>
                                                    <a class="lab-btn" href="https://charusat.ac.in/cms/"><span>Complaint Registration System</span></a>
                                                    </div>
                                                    <br/><br/>
                                                    <Contact
                                            ...
                                            <div className="accordion-item">
                                                <div className="accordion-header" id="accordion02">
                                                    <button className="d-flex flex-wrap justify-content-between" data-bs-toggle="collapse" data-bs-target="#videolist2" aria-expanded="true" aria-controls="videolist2" onClick={() => setIsActive(!isActive)}> <span>Sports Section</span> <span>{isActive ? '-' : '+'}</span> </button>
                                                </div>
                                            ...
                                            <div className="accordion-item">
                                                <div className="accordion-header" id="accordion03">
                                                    <button className="d-flex flex-wrap justify-content-between" data-bs-toggle="collapse" data-bs-target="#videolist3" aria-expanded="true" aria-controls="videolist3" onClick={() => setIsActive(!isActive)}><span>Examination Section</span> <span>{isActive ? '-' : '+'}</span> </button>
                                                </div>
                                            ...
                                            <div className="accordion-item">
                                                <div className="accordion-header" id="accordion04">
                                                    <button className="d-flex flex-wrap justify-content-between" data-bs-toggle="collapse" data-bs-target="#videolist4" aria-expanded="true" aria-controls="videolist4" onClick={() => setIsActive(!isActive)}> <span>HR Section</span> <span>{isActive ? '-' : '+'}</span> </button>
                                                </div>
                                                <div id="videolist4" className="accordion-collapse collapse" aria-labelledby="accordion04" data-bs-parent="#accordionExample">
                                                    <div className="row">
                                                        <div className="col-lg">
                                                        <h6>Service Rules: <a href={servicerules} target="_blank" rel="noreferrer">Download &nbsp;<i class="icofont-download"></i></a><br/></h6>
                                                        <Contact
                                            ...
                                            <div className="accordion-item">
                                                <div className="accordion-header" id="accordion05">
                                                    <button className="d-flex flex-wrap justify-content-between" data-bs-toggle="collapse" data-bs-target="#videolist5" aria-expanded="true" aria-controls="videolist5" onClick={() => setIsActive(!isActive)}> <span>Accounts Section</span> <span>{isActive ? '-' : '+'}</span> </button>
                                                </div>
