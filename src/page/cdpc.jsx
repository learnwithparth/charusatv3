                      ...
                      <div className="post-item style-2">
                        <div className="post-inner">
                          <div className="post-content">
                            ...
                            <br />
                            <h4>
                              Unleashing Your Full Potential with Unique
                              Assistance!
                            </h4>
                            ...
                            <ul className="lab-ul">
                              ...
                              <li>
                                ...
                                structured placement and training programme
                                which includes mock placement drive, aptitude
                                training and more, we help you bag your dream
                              ...
                              <li>
                                ...
                                information you seek. Moreover, be it assistance
                                with course selection, qualifying tests
                                (GATE/GRE/TOEFL/CAT), letter of recommendation,
                                statement of purpose, document verification or
                                application process and visa, you will receive
                              ...
                              <li>
                                ...
                                also encourage students to join Armed forces and
                                conduct seminar or lectures by experts from
                                Navy, NCC, IAS/IPS officers, etc.
                              </li>
                            </ul>
                          </div>
                        </div>
