                      ...
                      <div className="post-item style-2">
                        <div className="post-inner">
                          <div className="post-content">
                            <h3>Cell for Prevention of Sexual Harassment (CPSH)</h3>
                            ...
                            <div className="meta-post" >
                              ...
                              {/* <ul> */}
                               ...
                               <li>Display of pornographic or other offensive or derogatory pictures, cartoons pamphlets or sayings </li>
                               ...
                               <li>Unwelcomed physical contacts and advances </li>
                               <li>A communication for sexual favors </li>
                               <li>Any other unwelcome, physical, verbal or non-verbal conduct of sexual nature directly, indirectly, or through electronic media like SMS, MMS, Social Networking sites etc. </li>
                               <li>Any act of Gender Discrimination such as denial of employment to women due to women’s reproductive role, or rigidity in attitude, which hinders the reproductive role of women (for example, non-flexible work hours and timings, non-availability of day care services, lack of maternity leave, etc). </li>
                              {/* </ul> */}
