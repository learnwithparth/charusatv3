...
const CourseList = [
  ...
  },
  {
    ...
    Intake:"180",
    Fees:"Rs 40,000/-",
    Eligibility:"CBSE/ISCE/State Board/Commerce Stream with minimum 50% required and Science Stream minimum 45% required, Any student within/outside Gujarat",
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FCA%20CMPICA/",
    brochureBtn:"Download Brochure",
    brochureLink:"https://charusat.ac.in/Downloads/Brochure/CMPICA/CMPICA_Brochure.pdf",
    websiteBtn:"Visit Website",
  ...
  },
  {
    ...
    syllabusLink:"#",
    brochureBtn:"Download Brochure",
    brochureLink:"https://charusat.ac.in/Downloads/Brochure/RPCP/RPCP_Brochure.pdf",
    websiteBtn:"Visit Website",
  ...
  },
  {
    ...
    brochureBtn:"Download Brochure",
    brochureLink:"https://charusat.ac.in/Downloads/Brochure/ARIP/ARIP_Brochure.pdf",
    websiteBtn:"Visit Website",
  ...
  },
  {
    ...
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FOS%20PDPIAS/Physics/",
    brochureBtn:"Download Brochure",
    brochureLink:"#",
    websiteBtn:"Visit Website",
  ...
  },
  {
    ...
    Eligibility:"CBSE/ISCE/State board Minimum 55% in PCM/B subject, Any student within/outside Gujarat",
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FOS%20PDPIAS/Biology/",
    brochureBtn:"Download Brochure",
    brochureLink:"#",
    websiteBtn:"Visit Website",
    websiteLink:"https://charusat.ac.in/pdpias/",
  ...
  },
  {
    ...
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FOS%20PDPIAS/Chemistry/",
    brochureBtn:"Download Brochure",
    brochureLink:"#",
    websiteBtn:"Visit Website",
    websiteLink:"https://charusat.ac.in/pdpias/",
  ...
  },
  {
    ...
    Intake:"30",
    Fees:"Rs 60,000/-",
    Eligibility:"B.Sc(Physics) minimum 50% required,Any student within/outside Gujarat",
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FOS%20PDPIAS/Physics/",
    brochureBtn:"Download Brochure",
    brochureLink:"#",
  ...
  },
  {
    ...
    faculty:"Faculty of Medical Sciences",
    Institute:"Bapubhai Desaibhai Patel Institute of Paramedical Science(BDPIPS)",
    CourseDuration: "04 Years",
    Intake:"30",
    Fees:"Rs 60,000/-",
  ...
  {
    courseName:"Bachelor of Science (Operation Theater and Anaesthesia Technology)",
    faculty:"Faculty of Medical Sciences",
    Institute:"Bapubhai Desaibhai Patel Institute of Paramedical Science(BDPIPS)",
    CourseDuration: "04 Years",
    Intake:"30",
  ...
  },
  {
    ...
    Intake:"30",
    Fees:"Rs 60,000/-",
    Eligibility:"B.Sc (Micro/Bio Technology/Chemistry and DMLT) minimum 50% required, Any student within/outside Gujarat",
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FMD%20CIPS/",
    brochureBtn:"Download Brochure",
    brochureLink:"#",
  ...
  },
  {
    ...
    Intake:"10",
    Fees:"Rs 1,00,000/-",
    Eligibility:"B.Sc (Medical Imaging Technology) minimum 50% required, Any student within/outside Gujarat",
    syllabusBtn:"View Syllabus",
    syllabusLink:"https://charusat.ac.in/Downloads/Syllabus/FMD%20CIPS/",
    brochureBtn:"Download Brochure",
    brochureLink:"#",
  ...
  {
    courseName:"Bachelor of Technology (Electronics and Communication Engineering)",
    faculty:"Faculty of Technology and Engineering",
    Institute:"Chandubhai S. Patel Insitute of Technology(CSPIT)",
    CourseDuration: "04 Years",
    Intake:"60",
                        ...
                        <div className="post-inner" >
                          <div className="post-content">
                            ...
                            <div className="meta-post" >
                              ...
                              <p><b>Fees:</b> {val.Fees}</p>
                              <p><b>Eligibility:</b> {val.Eligibility}</p>
                              {val.syllabusLink!=="#" ? (
                                <a class="lab-btn" href={val.syllabusLink}><span>{val.syllabusBtn}</span></a>
                                ) : (
                                 <span></span>
                              )}
                              {" "}
                              {val.brochureLink!=="#" ? (
                                <a class="lab-btn" href={val.brochureLink}><span>{val.brochureBtn}</span></a>
                                ) : (
                                 <span></span>
                              )}
                              {" "}
                              {val.websiteLink!=="#" ? (
                                <a class="lab-btn" href={val.websiteLink}><span>{val.websiteBtn}</span></a>
                                ) : (
                                 <span></span>
                              )}
                              {" "}
